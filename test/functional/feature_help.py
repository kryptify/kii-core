...
"""Verify that starting kiid with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start kiid with -h for help text")
        ...
        self.log.info("Start kiid with -version for version information")
