...
* kii.conf: contains configuration settings for kiid or kii-qt
* kiid.pid: stores the process id of kiid while running
...
* debug.log: contains debug information and general logging generated by kiid or kii-qt
