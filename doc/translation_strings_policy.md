...
This document provides guidelines for internationalization of the KII Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `kii_en.ts` remains unchanged.
