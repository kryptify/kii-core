...
Arguments:
    <base_directory> - The base directory of a KII Core source code repository.
...
YEAR = "20[0-9][0-9]"
YEAR_RANGE = '(%s)(-%s)?' % (YEAR, YEAR)
HOLDER = 'The KII Core developers'
...
Arguments:
    <base_directory> - The base directory of KII Core source code repository.
"""
...
Arguments:
    <file> - A source file in the KII Core repository.
"""
