# Linearize
Construct a linear, no-fork, best version of the KII blockchain. The scripts
...
JSON-RPC server. Running `kiid` or `kii-qt -server` will be sufficient.
...
* `input`: kiid blocks/ directory containing blkNNNNN.dat
