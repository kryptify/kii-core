...
/** Utility functions used by the KII Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "kii:" URI into recipient object, return true on successful parsing
    ...
    */
    ...
    /** Load kii specific appliciation fonts */
    bool loadFonts();
    ...
    /** Check if a kii specific theme is activated (light/dark).*/
    bool kiiThemeActive();
