...
//! Interface for the src/evo part of a kii node (kiid process).
class EVO
{
public:
    virtual ~EVO() {}
...
//! Interface for the src/llmq part of a kii node (kiid process).
class LLMQ
{
public:
    virtual ~LLMQ() {}
...
//! Interface for the src/masternode part of a kii node (kiid process).
