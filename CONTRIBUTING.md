Contributing to KII Core
============================

The KII Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/kiiglobal/kii-core/blob/master/doc/translation_process.md) 
...
The following applies to code changes to the KII Core project (and related
projects such as libsecp256k1), and is not to be confused with overall KII
Network Protocol consensus changes.

Whether a pull request is merged into KII Core rests with the project merge
...
Patches that change KII consensus rules are considerably more involved than
...
Where a patch set proposes to change the KII consensus, it must have been
...
The review process is normally fairly responsive on the KII Core repository, however
...
The project leader is the release manager for each KII Core release.
